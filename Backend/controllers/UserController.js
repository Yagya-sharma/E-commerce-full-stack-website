...
export const verify = async (req, res) => {
    try {
        ...
        const token = authHeader.split(" ")[1]  //[Bearer, sschfrhffrrr]
        let decoded
        try {
...
export const updateUser = async (req, res) => {
    try {
        ...
        const loggedInUser = req.user //from inAuthenticated middleware
        ...
        if (role !== undefined && loggedInUser.role === "admin") {
            user.role = role
        }
