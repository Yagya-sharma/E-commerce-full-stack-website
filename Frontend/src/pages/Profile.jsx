      ...
      <TabsContent value="profile">
        <div className="flex justify-center">
          <div className="w-full max-w-5xl bg-white shadow-lg rounded-xl p-6 sm:p-10">
            ...
            <h1 className="font-bold mb-8 text-2xl text-gray-800 text-center">
              Update Profile
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
              ...
              <div className="flex flex-col items-center">
                <img
                  ...
                  className="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-pink-600"
                />
                <Label className="mt-4 cursor-pointer bg-pink-600 text-white px-4 py-2 rounded-md hover:bg-pink-700">
                  Change Picture
                  <input
                    type="file"
                    accept="image/*"
