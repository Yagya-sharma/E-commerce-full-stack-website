...
const OrderCard = ({userOrder}) => {
  ...
  return (
    ...
    //     {
    //         userOrder?.length===0?(
    //             <p className='text-gray-800 space-y-6 text-2xl'>No Order found for this users</p>
    //         ):(
    ...
    //                                 <h2 className='text-lg font-semihold'>Order ID:{" "} 
    ...
    //                                         <span className='font-medium'>User:w</span>{" "}
    ...
    //                                             <li key={index} className='flex justify-between items-center bg-gray-50 rounded-lg'>
    ...
    <div className='pr-20 flex flex-cols gap-3'>
        <div className='w-full p-6'>
            <div className='flex items-center gap-4 mb-6'>
                <Button onClick={()=>navigate(-1)}><ArrowLeft/></Button>
                <h1 className='text-2xl font-bold'>Orders</h1>
